...
import { CronWorker, CrobJobSchedule } from './background-worker/cron-worker';
...
async function bootstrap() {
  ...
  RabbitMQHelper.startConsumers([
    { queue: TravailQueue.SIGNON, handle: app.get(SignOnConsumer).handle },
  ]);
